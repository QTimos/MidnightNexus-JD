...
```
git clone https://github.com/QTimos/MidnightNexus-JD.git
```
...
5. Get the `flatlaf.jar` file and replace the one in `JDownloader\libs\laf\` with it.
6. Restart JDownloader2
